...
function getRandomInt(min, max) {
    ...
    document.getElementById("numero4").innerHTML = "*"
...
//-- Elementos de la gui
const gui = {
    display : document.getElementById("clave"),
    start : document.getElementById("start"),
    stop : document.getElementById("stop"),
    reset : document.getElementById("reset"),
    contador1 : document.getElementById("numero1"),
    contador2 : document.getElementById("numero2"),
    contador3 : document.getElementById("numero3"),
    contador4 : document.getElementById("numero4"),
}
